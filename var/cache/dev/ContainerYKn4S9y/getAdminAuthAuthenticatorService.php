 ...
 */
class getAdminAuthAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AdminAuthAuthenticator.php';

        return $container->privates['App\\Security\\AdminAuthAuthenticator'] = new \App\Security\AdminAuthAuthenticator(($container->services['router'] ?? self::getRouterService($container)));
    }
}
