 ...
 */
class getNomActiviteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NomActiviteRepository' shared autowired service.
     *
     * @return \App\Repository\NomActiviteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NomActiviteRepository.php';

        return $container->privates['App\\Repository\\NomActiviteRepository'] = new \App\Repository\NomActiviteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
