 ...
 */
class getOffreClientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OffreClientRepository' shared autowired service.
     *
     * @return \App\Repository\OffreClientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OffreClientRepository.php';

        return $container->privates['App\\Repository\\OffreClientRepository'] = new \App\Repository\OffreClientRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
