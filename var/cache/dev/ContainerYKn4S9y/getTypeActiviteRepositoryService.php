 ...
 */
class getTypeActiviteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeActiviteRepository' shared autowired service.
     *
     * @return \App\Repository\TypeActiviteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeActiviteRepository.php';

        return $container->privates['App\\Repository\\TypeActiviteRepository'] = new \App\Repository\TypeActiviteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
